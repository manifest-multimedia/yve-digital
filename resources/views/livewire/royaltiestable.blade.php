<div>
    ...
    <div class="panel-body custom-body">
        ...
        @can('isAdmin')
            ...
            @endif
            {{-- Edit --}}
            <h3> <strong>Edit Record</strong> </h3> <hr>
            <div class="col-md-8"> </div>  
            <div class="col-md-4">
                <button class="btn btn-primary" wire:click="update({{$record}})">Update </button>
                <button class="btn btn-danger" wire:click="cancel">Cancel </button> <hr/>
            </div> 
            ...
            @if($royalties->count()!=0)
                <div class="col-md-12">
                    <div class="list-heading-area-no-border">
                        ...
                        {{-- End Records Table --}}    
                        {{ $royalties->links() }}
                        <div class="dataTables_info" id="transtable_info" role="status" aria-live="polite">Showing 1 to 5 of 5 entries</div><div class="dataTables_paginate paging_simple_numbers" id="transtable_paginate"><a class="paginate_button previous disabled" aria-controls="transtable" data-dt-idx="0" tabindex="-1" id="transtable_previous">Previous</a><span><a class="paginate_button current" aria-controls="transtable" data-dt-idx="1" tabindex="0">1</a></span><a class="paginate_button next disabled" aria-controls="transtable" data-dt-idx="2" tabindex="-1" id="transtable_next">Next</a></div>
                    </div>
                </div>
            @endif
            ...
            @if ($royalties->count()==0)
                @can('isAdmin')
                    <div class="table-box">
                        ...
                        <div class="col-md-6"><strong> User <input type="text" class="form-control" value= '$ {{$earnings}}' /> </strong></div>          
                            <table id="transtable" class="table dataTable no-footer" style="width: 100%;" role="grid" aria-describedby="transtable_info"> 
                                <thead>
                                    <tr role="row">
                                        <th class="sorting sorting_asc" tabindex="0" aria-controls="transtable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 100px;">Period</th>
                ...
                @can('isUser')
                    <div class="alert alert-danger"> Sorry No Records Were Found. </div>
                @endcan
            @endif 
