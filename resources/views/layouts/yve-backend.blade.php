...
<head>
	...
	<title>DASHBOARD SCREEN 1</title>
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<div>
			...
			<ul class="nav menu">
				<li class="active"><a href="index.html">MUSIC</a></li>
				...
				<div class="panel panel-default bo-radius">
					<div class="panel-heading">
						<div class="heading-bar">
							<div class="greetings">
								<h1 class="greet">Good morning, Fameye</h1>
					...
					<div class="panel-heading">
						...
						<div class="panel-body custom-body">
							<div class="panel panel-default">
								<div class="panel-body tabs">
									<ul class="nav nav-pills custom-pills">
										<li class="active"><a href="#pilltab11" data-toggle="tab" aria-expanded="true">RELEASE DETAILS</a></li>
										<li class=""><a href="#pilltab22" data-toggle="tab" aria-expanded="false">TRACK LIST</a></li>
										<li class=""><a href="#pilltab33" data-toggle="tab" aria-expanded="true">SCHEDULE</a></li>
										<li class=""><a href="#pilltab44" data-toggle="tab" aria-expanded="true">DISTRIBUTION</a></li>
									</ul>
									<div class="tab-content">
										<div class="tab-pane fade active in" id="pilltab11">
										...
										<div class="tab-pane fade" id="pilltab22">
											<div class="spacer">
												Ready to get your music out there?

											</div>
										</div>
										<div class="tab-pane fade  in" id="pilltab33">
											<div class="spacer">
												Ready to get your music out there?

											</div>
										</div>
										<div class="tab-pane fade  in" id="pilltab44">
											<div class="spacer">
												Ready to get your music out there?

											</div>
										</div>
										<div class="tab-pane fade" id="pilltab55">
											<div class="spacer">
												TEXT
											</div>
										</div>
